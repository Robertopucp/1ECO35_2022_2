...
write.csv(junin2, '../data/Base_cleaned_WG(9).csv')   #guardado en csv

# install.packages("xlsx")    instalar paquete de ser necesario
# library(xlsx)

write.xlsx(junin2, '../data/Base_cleaned_WG(9).xlsx') #guardado en xlsx